package filecatalog.rmi.jdbc.server.net;

import filecatalog.rmi.jdbc.common.Constants;
import filecatalog.rmi.jdbc.common.exceptions.*;
...
public class FileTransferConnectionHandler implements Runnable {

	public static final String FILES_DIRECTORY = "./FilesStorage/";
	private final Socket clientSocket;
	private DataInputStream input;
	private DataOutputStream output;
	private boolean connected = true;

	public FileTransferConnectionHandler(Socket clientSocket) {
